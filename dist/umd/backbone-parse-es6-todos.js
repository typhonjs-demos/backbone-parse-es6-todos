...
$__System.register('6', ['4', '7', '8', '9', 'a', 'b', 'c'], function (_export) {
...
$__System.register('e', ['4', '8', '9', '10', 'a', 'b', 'c', 'f', 'd'], function (_export) {
   var Parse, Backbone, _get, eventbus, _inherits, _createClass, _classCallCheck, _, loginTmpl, LogInView;
...
$__System.register('37', ['9', '36', '38', '39', 'a', 'b', 'c', 'f'], function (_export) {
   var _get, logger, Utils, TyphonEvents, _inherits, _createClass, _classCallCheck, _, TyphonLoggedEvents;
...
$__System.register('10', ['37'], function (_export) {
  'use strict';
...
$__System.register('3b', ['8', '9', 'a', 'b', 'c', 'f', '3a'], function (_export) {
...
$__System.register('3e', ['7', '8', '9', '10', '32', '40', 'a', 'b', 'c', '3f', 'f', '3b', '3c', '3d'], function (_export) {
   var appState, Backbone, _get, eventbus, _Map, todoList, _inherits, _createClass, _classCallCheck, $, _, ItemView, manageTodosTmpl, statsTmpl, ManageTodosView;
...
$__System.register('42', ['43', 'c', '3f', 'f'], function (_export) {
  var BackboneProxy, _classCallCheck, $, _, Backbone;
...
$__System.register('44', ['9', '43', '45', '46', '47', '48', 'a', 'b', 'c', 'f'], function (_export) {
   var _get, BackboneProxy, Model, Utils, Debug, Events, _inherits, _createClass, _classCallCheck, _, s_ADD_OPTIONS, s_SET_OPTIONS, s_ADD_REFERENCE, s_ON_MODEL_EVENT, s_REMOVE_MODELS, s_REMOVE_REFERENCE, s_SPLICE, Collection, collectionMethods;
...
$__System.register('49', ['b', 'c', 'f'], function (_export) {
...
$__System.register('4b', ['9', '44', '47', 'a', 'b', 'c', 'f', '4c', '4a'], function (_export) {
   var _get, Collection, Debug, _inherits, _createClass, _classCallCheck, _, Model, BackboneQuery, ParseCollection;
...
$__System.register('39', ['9', '48', 'a', 'b', 'c', '4d', 'f'], function (_export) {
   var _get, Events, _inherits, _createClass, _classCallCheck, _Promise, _, TyphonEvents, s_EVENT_SPLITTER, s_EVENTS_API, s_TRIGGER_API, s_TRIGGER_FIRST_EVENTS, s_TRIGGER_RESULTS_EVENTS, s_TRIGGER_THEN_EVENTS;
...
$__System.register('4e', ['9', '46', '48', 'a', 'b', 'c', 'f'], function (_export) {
   var _get, Utils, Events, _inherits, _createClass, _classCallCheck, _, s_ROUTE_STRIPPER, s_ROOT_STRIPPER, s_PATH_STRIPPER, s_UPDATE_HASH, History;
...
$__System.register('45', ['9', '43', '46', '48', 'a', 'b', 'c', 'f'], function (_export) {
   var _get, BackboneProxy, Utils, Events, _inherits, _createClass, _classCallCheck, _, Model, modelMethods;
...
$__System.register('46', ['43', '69', 'b', 'c', 'f'], function (_export) {
   var BackboneProxy, _toConsumableArray, _createClass, _classCallCheck, _, s_ADD_METHOD, s_CB, s_MODEL_MATCHER, Utils;
...
$__System.register('4c', ['4', '9', '38', '45', '46', '47', 'a', 'b', 'c', '4d', 'f', '6a'], function (_export) {
   var Parse, _get, Utils, Model, BBUtils, Debug, _inherits, _createClass, _classCallCheck, _Promise, _, BackboneParseObject, ParseModel;
...
$__System.register('75', ['9', '43', '48', '69', 'a', 'b', 'c', 'f'], function (_export) {
   var _get, BackboneProxy, Events, _toConsumableArray, _inherits, _createClass, _classCallCheck, _, s_ESCAPE_REGEX, s_NAMED_PARAM, s_OPTIONAL_PARAM, s_SPLAT_PARAM, s_BIND_ROUTES, s_EXTRACT_PARAMETERS, s_ROUTE_TO_REGEX, Router;
...
$__System.register('48', ['b', 'c', 'f'], function (_export) {
...
$__System.register('76', ['9', '43', '48', 'a', 'b', 'c', 'f'], function (_export) {
  var _get, BackboneProxy, Events, _inherits, _createClass, _classCallCheck, _, s_DELEGATE_EVENT_SPLITTER, s_VIEW_OPTIONS, View;
...
$__System.register('77', ['43', '47', 'f'], function (_export) {
...
$__System.register('b2', ['f'], function (_export) {
...
$__System.register('b4', ['4', 'f', 'b2', 'b3'], function (_export) {
...
$__System.registerDynamic("f", ["b5"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
$__System.register('b7', ['38', 'f'], function (_export) {
...
$__System.register('ba', ['4', '6', '7', '8', '10', '40', 'b', 'c', 'e', '3e'], function (_export) {
   var Parse, AppRouter, appState, Backbone, eventbus, todoList, _createClass, _classCallCheck, LogInView, ManageTodosView, App, s_INITIALIZE_ROUTE;
   ...
   return {
      setters: [function (_2) {
         ...
         LogInView = _e['default'];
      }, function (_e2) {
         ManageTodosView = _e2['default'];
      }],
      execute: function () {
